...
const Cars = () => {
  ...
  return (
    <div>
        ...
        className='flex flex-col items-center py-20 bg-gray-900 max-md:px-4' >
          ...
          className='flex items-center bg-gray-800 border border-gray-700 px-4 mt-6 max-w-140 w-full h-12 rounded-full shadow' >
            <img src={assets.search_icon} alt="" className='w-4.5 h-4.5 mr-2' />

            <input onChange={(e) => setInput(e.target.value)} value={input} type="text" placeholder='Search by make, model and features' className='w-full h-full outline-none text-gray-200 bg-transparent placeholder-gray-400' />
